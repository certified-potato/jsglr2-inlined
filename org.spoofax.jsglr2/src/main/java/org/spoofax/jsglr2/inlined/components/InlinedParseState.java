...
public class InlinedParseState {
    ...
    private RecoveryJob<InlinedFakeStackNode> recoveryJob = null;
    ...
    public InlinedFakeStackNode acceptingStack;
    ...
    public BacktrackChoicePoint<InlinedInputStack, InlinedFakeStackNode> createBacktrackChoicePoint() {
        // This cast is ugly, but there's no way around it (see
        // AbstractRecoveryParseState)
    ...
    protected void resetToBacktrackChoicePoint(BacktrackChoicePoint backtrackChoicePoint) {
        ...
        // The subclasses of `IInputStack` specialize the return type of `clone` to be
        // their own class,
        // but this information cannot be stored in the type parameter `InputStack` of
        // this class.
        // As programmers, we assume that the backtrack choice points contain an input
        // stack of the same type each time.
