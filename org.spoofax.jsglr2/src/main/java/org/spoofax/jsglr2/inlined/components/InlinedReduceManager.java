...
public class InlinedReduceManager {
    ...
    public InlinedReduceManager(IParseTable parseTable,
            InlinedStackManager stackManager,
            InlinedParseForestManager parseForestManager) {
            this.parseTable = parseTable;
            this.stackManager = stackManager;
            this.parseForestManager = parseForestManager;
            this.reduceActionFilters = new ArrayList<>();
            this.reducer = new RecoveryReducerOptimized<>(stackManager, parseForestManager);
        }
        ...
        //@formatter:off
           <ParseForest_  extends IParseForest,
            ...
            StackManager_ extends InlinedStackManager<ParseForest_, Derivation_, ParseNode_, StackNode_, ParseState_>>
        //@formatter:on
